...
RUN set -eux \
    ...
    && curl -f https://www.dcm4che.org/maven2/org/dcm4che/jdbc-jboss-modules-mariadb/3.3.3/jdbc-jboss-modules-mariadb-3.3.3.tar.gz | tar xz \
    ...
    && curl -fO https://allclinic.com.br/dcm4che/${DCM4CHEE_ARC_VERSION}/dcm4chee-arc-ear-${DCM4CHEE_ARC_VERSION}-mysql.ear \
